// Тест Вход. Страница "Подписки". Создание счёта для Юр.лица
...
async function creatingCompanyInvoice() {
    ...
    try {
        ...
        const textAreaElements = await driver.findElements(By.css('.subscriptionsInvoicePay__payment'));
        await textAreaElements[2].click();
        await driver.sleep(1000);
        await takeScreenshot(driver, './screenshots/invoice1.png');
